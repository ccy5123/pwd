...
- Basis: interval rule: CI=[0.875067, 0.92078] above null_value=0 (support_side='above', combine='latest')
- Evidence validity: referent=empirical; data_source(s)=measured
...
- Basis: interval rule: CI=[0.720382, 0.951173] above null_value=0 (support_side='above', combine='latest')
- Evidence validity: referent=empirical; data_source(s)=measured
...
- Basis: interval rule: CI=[-0.0445379, 0.77377] contains null_value=0 (support_side='above', combine='latest')
- Evidence validity: referent=empirical; data_source(s)=measured
...
## Evidence
- `evi-pmodel-priorwork-20260617-055045-46175639` (literature): finding={"searched_via": "agent web_search (June 2026)", "key_prior_art": ["Endo, Brown, Goss 2013, Environ. Sci. Technol. 47, 6
- `evi-pmodel-membrane-surrogate-scan-20260617-055045-298dabc4` (observation): finding={"phase": "membrane", "what": "full single-surrogate direct-R2 field (all 72)", "purpose": "anti method-shopping: record
- `evi-pmodel-membrane-useful-20260617-055046-6c5fe4d2` (experiment_run): point=0.905935, finding={"phase": "membrane", "n": 207, "n_features": 72, "cv_r2_mean": 0.905935, "cv_r2_std": 0.013007, "cv_r2_p2.5": 0.875067,
- `evi-pmodel-membrane-reliable-20260617-055046-92214831` (experiment_run): point=0.905935, ci=[0.8750667251650199, 0.920779714642778], finding={"phase": "membrane", "n": 207, "n_features": 72, "cv_r2_mean": 0.905935, "cv_r2_std": 0.013007, "cv_r2_p2.5": 0.875067,
- `evi-pmodel-storage-surrogate-scan-20260617-055046-5a2eea05` (observation): finding={"phase": "storage", "what": "full single-surrogate direct-R2 field (all 72)", "purpose": "anti method-shopping: record 
- `evi-pmodel-storage-useful-20260617-055048-7b74dd10` (experiment_run): point=0.89816, finding={"phase": "storage", "n": 247, "n_features": 72, "cv_r2_mean": 0.89816, "cv_r2_std": 0.065187, "cv_r2_p2.5": 0.720382, "
- `evi-pmodel-storage-reliable-20260617-055048-3bdf1ecd` (experiment_run): point=0.89816, ci=[0.7203824521242818, 0.9511734599903524], finding={"phase": "storage", "n": 247, "n_features": 72, "cv_r2_mean": 0.89816, "cv_r2_std": 0.065187, "cv_r2_p2.5": 0.720382, "
- `evi-pmodel-albumin-surrogate-scan-20260617-055048-2c6d33d1` (observation): finding={"phase": "albumin", "what": "full single-surrogate direct-R2 field (all 72)", "purpose": "anti method-shopping: record 
- `evi-pmodel-albumin-useful-20260617-055048-983c7105` (experiment_run): point=0.643803, finding={"phase": "albumin", "n": 83, "n_features": 72, "cv_r2_mean": 0.643803, "cv_r2_std": 0.029585, "cv_r2_p2.5": 0.584901, "
- `evi-pmodel-albumin-reliable-20260617-055048-ac3a4bf0` (experiment_run): point=0.643803, ci=[0.5849005511312755, 0.6827859390066181], finding={"phase": "albumin", "n": 83, "n_features": 72, "cv_r2_mean": 0.643803, "cv_r2_std": 0.029585, "cv_r2_p2.5": 0.584901, "
- `evi-pmodel-muscle_chicken-surrogate-scan-20260617-055048-786df24a` (observation): finding={"phase": "muscle_chicken", "what": "full single-surrogate direct-R2 field (all 72)", "purpose": "anti method-shopping: 
- `evi-pmodel-muscle_chicken-useful-20260617-055049-dfba78e7` (experiment_run): point=0.645867, finding={"phase": "muscle_chicken", "n": 46, "n_features": 72, "cv_r2_mean": 0.645867, "cv_r2_std": 0.299649, "cv_r2_p2.5": -0.0
- `evi-pmodel-muscle_chicken-reliable-20260617-055049-0aa68b3c` (experiment_run): point=0.645867, ci=[-0.04453787730599823, 0.7737702236909137], finding={"phase": "muscle_chicken", "n": 46, "n_features": 72, "cv_r2_mean": 0.645867, "cv_r2_std": 0.299649, "cv_r2_p2.5": -0.0
- `evi-pmodel-muscle_fish-surrogate-scan-20260617-055049-04b0d35e` (observation): finding={"phase": "muscle_fish", "what": "full single-surrogate direct-R2 field (all 72)", "purpose": "anti method-shopping: rec
- `evi-pmodel-muscle_fish-useful-20260617-055050-d465c8b8` (experiment_run): point=0.647872, finding={"phase": "muscle_fish", "n": 45, "n_features": 72, "cv_r2_mean": 0.647872, "cv_r2_std": 0.120152, "cv_r2_p2.5": 0.35840
- `evi-pmodel-muscle_fish-reliable-20260617-055050-c3953695` (experiment_run): point=0.647872, ci=[0.35840176031305404, 0.7669796095297748], finding={"phase": "muscle_fish", "n": 45, "n_features": 72, "cv_r2_mean": 0.647872, "cv_r2_std": 0.120152, "cv_r2_p2.5": 0.35840
