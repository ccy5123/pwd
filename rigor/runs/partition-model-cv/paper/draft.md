...
## Evidence
- `evi-pmodel-priorwork-20260617-053617-1256886a` (literature): finding={"searched_via": "agent web_search (June 2026)", "key_prior_art": ["Endo, Brown, Goss 2013, Environ. Sci. Technol. 47, 6
- `evi-pmodel-membrane-useful-20260617-053619-dafccfbe` (experiment_run): point=0.905935, finding={"phase": "membrane", "n": 207, "n_features": 72, "cv_r2_mean": 0.905935, "cv_r2_std": 0.013007, "cv_r2_p2.5": 0.875067,
- `evi-pmodel-membrane-reliable-20260617-053619-f81c7477` (experiment_run): point=0.905935, ci=[0.8750667251650199, 0.920779714642778], finding={"phase": "membrane", "n": 207, "n_features": 72, "cv_r2_mean": 0.905935, "cv_r2_std": 0.013007, "cv_r2_p2.5": 0.875067,
- `evi-pmodel-storage-useful-20260617-053620-4a68a05a` (experiment_run): point=0.89816, finding={"phase": "storage", "n": 247, "n_features": 72, "cv_r2_mean": 0.89816, "cv_r2_std": 0.065187, "cv_r2_p2.5": 0.720382, "
- `evi-pmodel-storage-reliable-20260617-053620-60217aa1` (experiment_run): point=0.89816, ci=[0.7203824521242818, 0.9511734599903524], finding={"phase": "storage", "n": 247, "n_features": 72, "cv_r2_mean": 0.89816, "cv_r2_std": 0.065187, "cv_r2_p2.5": 0.720382, "
- `evi-pmodel-albumin-useful-20260617-053621-a73576b9` (experiment_run): point=0.643803, finding={"phase": "albumin", "n": 83, "n_features": 72, "cv_r2_mean": 0.643803, "cv_r2_std": 0.029585, "cv_r2_p2.5": 0.584901, "
- `evi-pmodel-albumin-reliable-20260617-053621-8e9f2b12` (experiment_run): point=0.643803, ci=[0.5849005511312755, 0.6827859390066181], finding={"phase": "albumin", "n": 83, "n_features": 72, "cv_r2_mean": 0.643803, "cv_r2_std": 0.029585, "cv_r2_p2.5": 0.584901, "
- `evi-pmodel-muscle_chicken-useful-20260617-053621-9867e94a` (experiment_run): point=0.645867, finding={"phase": "muscle_chicken", "n": 46, "n_features": 72, "cv_r2_mean": 0.645867, "cv_r2_std": 0.299649, "cv_r2_p2.5": -0.0
- `evi-pmodel-muscle_chicken-reliable-20260617-053621-e7ec6bc5` (experiment_run): point=0.645867, ci=[-0.04453787730599823, 0.7737702236909137], finding={"phase": "muscle_chicken", "n": 46, "n_features": 72, "cv_r2_mean": 0.645867, "cv_r2_std": 0.299649, "cv_r2_p2.5": -0.0
- `evi-pmodel-muscle_fish-useful-20260617-053622-05d6d41e` (experiment_run): point=0.647872, finding={"phase": "muscle_fish", "n": 45, "n_features": 72, "cv_r2_mean": 0.647872, "cv_r2_std": 0.120152, "cv_r2_p2.5": 0.35840
- `evi-pmodel-muscle_fish-reliable-20260617-053622-ec416412` (experiment_run): point=0.647872, ci=[0.35840176031305404, 0.7669796095297748], finding={"phase": "muscle_fish", "n": 45, "n_features": 72, "cv_r2_mean": 0.647872, "cv_r2_std": 0.120152, "cv_r2_p2.5": 0.35840
